...
type Props = ProblemSetSearchProps & typeof statePropTypes & typeof actionPropTypes;
    ...
    return (
      <div className="ProblemSetSearch">
        ...
        <div>
          ...
          <select id='creator' value={this.state.creator}
            onChange={(event) => {this.setState({ creator: event.target.value })}}>
            <option value='open'>open</option>
            <option value='own'>own</option>
          </select>
          <select id='tag' value={this.state.tag}
          ...
          <select id='sort' value={this.state.sort}
